...
public class Disable implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        try {
            ...
            Utilities.Message((Player) sender, "&c&lReloadPlugin &7| &7Disabled &f&n" + target.getName().toString() + "&7 successfully.");
        } catch(Exception e) {
            Utilities.Message((Player) sender, "&c&lReloadPlugin &7| &7Failed to disable &f&n" + target.getName().toString() + "&7. Please check the console");
            e.printStackTrace();
        }
